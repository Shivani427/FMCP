...
var ProductionCost = {
    ...
    checkAllFormFieldsForTotalRequired: function() {
        var fieldList = Array('TOTAL_DIRECT_COST', 'OVERHEAD_COST', 'DEPRECIATION_COST', 'INTEREST_COST', 'ROYALTY_COST', 'TAXES_COST', 'DEAD_RENT_COST', 'OTHERS_COST');
    ...
    fieldValidation: function(overHeadField) {
        ...
        //      console.log(value)
        //      if(element.id == 'TOTAL_COST'){
        //        if(!isNaN(parseFloat(value))){
        //          _this.fieldArray['totalFieldData'] = parseFloat(value);  
        //          _this.totalCount(_this.fieldArray);
        //        }
        //        return true;
        //      }
        //      else{
        //        var elementId = element.id;
        //        _this.fieldArray[elementId] = parseFloat(value);
        //        if(!isNaN(_this.fieldArray['totalFieldData'])){
        //          _this.fieldArray['totalFieldData'] = $("#TOTAL_COST").val();
        //          _this.totalCount(_this.fieldArray);
        //        }
        //        return true;
        //      }
    ...
    totalCount: function(fieldArray) {
        ...
        var total = (fieldArray['BENEFICIATION_COST'] + fieldArray['DEAD_RENT_COST'] +
            ...
            fieldArray['OVERHEAD_COST'] + fieldArray['ROYALTY_COST'] + fieldArray['TAXES_COST'] +
...
var NameAndAddress = {
    fieldValidation: function() {
        ...
        $("#formNameAddress").validate({
            rules: {
                "F[LESSEE_OFFICE_NAME]": {
                    required: true,
                    maxlength: 250
                },
                "F[DIRECTOR_NAME]": {
...
var Particular = {
    fieldValidation: function() {
        ...
        /*$("#frmParticulars").validate({
         ...
         $.format("Min. length must be {0} digits"));
        ...
        $.validator.addMethod("leaseMaxlength", $.validator.methods.maxlength,
            $.format("Max. length allowed is {0}"));
        ...
        $.validator.addMethod("cNumber", $.validator.methods.number,
            $.format("Please enter numeric digits only"));
        $.validator.addMethod("cMax", $.validator.methods.max,
            $.format("Max. value allowed is {0}"));
        $.validator.addMethod("cMaxlength", $.validator.methods.maxlength,
            $.format("Max. length allowed is 5,3 digits including decimal"));
        ...
        $.validator.addMethod("cMax", $.validator.methods.max,
            $.format("Max. value allowed is {0}"));
        $.validator.addMethod("cMaxlength", $.validator.methods.maxlength,
            $.format("Max. length allowed is 6,3 digits including decimal"));
        ...
        $.validator.addMethod("cMax", $.validator.methods.max,
            $.format("Max. value allowed is {0}"));
        $.validator.addMethod("cMaxlength", $.validator.methods.maxlength,
            $.format("Max. length allowed is {0} digits including decimal"));
...
var EmploymentWages = {
    fieldValidation: function() {
        ...
        $.validator.addMethod("aDigits", $.validator.methods.digits,
            $.format("Decimal digits are not allowed"));
        ...
        $.validator.addMethod("checkDays", function(value, element) {
            ...
            if (totalDays > parseInt(totalYearDays)) {
                ...
                // @version 6th Feb 2014
                if (leapFlag == 1){
                    alert("Total of 'work stoppage days' + 'Number of days mine worked' should not exceed 366 (as it's Leap Year).")
                    return false;
                }
                else{
                    alert("Total of 'work stoppage days' + 'Number of days mine worked' should not exceed 365.")
                    return false;
                }
            }
...
var CapStruc = {
    fieldValidation: function() {
        ...
        $.validator.addMethod('qRequired', $.validator.methods.required,
            $.format("Please enter Net Closing Balance"));
        ...
        $.validator.addMethod("lMax", $.validator.methods.max,
            $.format("Max. value allowed is 99.99"));
        ...
        $.validator.addMethod("gRequired", $.validator.methods.required,
            $.format("Please enter vertical total"));
...
var SecFour = {
    fieldValidation: function() {
        ...
        $.validator.addMethod("aNumber", $.validator.methods.number,
            $.format("Please enter numeric digits only"));
        $.validator.addMethod("aDigits", $.validator.methods.digits,
            $.format("Decimal numbers are not allowed"));
...
var SecGreatThenFour = {
    fieldVaidation: function() {
        ...
        $.validator.addMethod("aMaxlength", $.validator.methods.maxlength,
            $.format("Max. length allowed is {0} digits including decimals"));
        $.validator.addMethod("aNumber", $.validator.methods.number,
            $.format("Please enter numeric digits only"));
        $.validator.addMethod("aMax", $.validator.methods.max,
            $.format("Max. value allowed can be 6,3 digits long"));
        ...
        $.validator.addMethod("cMaxlength", $.validator.methods.maxlength,
            $.format("Max. length allowed is {0} characters"));
        ...
        $.validator.addMethod("dNumber", $.validator.methods.number,
            $.format("Please enter numeric digits only"));
        $.validator.addMethod("dDigits", $.validator.methods.digits,
            $.format("Decimals digits are not allowed"));
...
var GeologyPart1 = {
    fieldValidation: function() {
        ...
        $.validator.addMethod('selectRequired', $.validator.methods.required,
            $.format("Please select the selectbox."));

        $.validator.addMethod('gradeRequired', $.validator.methods.required,
            $.format("Please enter the grade."));
        ...
        $.validator.addMethod("gradeMax", $.validator.methods.max,
            $.format("Max. value allowed can be 99.99"));
...
var EmploymentWagesPart2 = {
    fieldValidation: function() {
        ...
        $.validator.addMethod("fTotalWages", function(value, element) {
            ...
            if (splittedId[0] == 'BELOW') {
                if (splittedId[1] == 'FOREMAN') {
                    alertMsg = 'for Below Ground Foreman and mining mates';
            ...
            if (splittedId[0] == 'OC') {
                if (splittedId[1] == 'FOREMAN') {
                    alertMsg = 'for Opencast Workings Foreman and mining mates';
                } else if (splittedId[1] == 'FACE') {
            ...
            if (splittedId[0] == 'ABOVE') {
                if (splittedId[1] == 'CLERICAL') {
                    alertMsg = 'for Above Ground Clerical & Supervisory Staff';
        ...
        $.validator.addMethod("cMaxlengthm", $.validator.methods.maxlength,
            $.format("should accept 4 digits before decimals"));
    ...
    validateBigFormula: function(){
        ...
        var formFullLabelArr = {
            "BELOW_FOREMAN_MAN_TOT" : "A.Below Ground Foreman and mining mates",
            "BELOW_FACE_MAN_TOT" : "A.Below Ground Face workers and Loaders",
            "BELOW_OTHER_MAN_TOT" : "A.Below Ground Others",
            "OC_FOREMAN_MAN_TOT" : "B.Opencast workings Foreman and mining mates",
            "OC_FACE_MAN_TOT" : "B.Opencast workings Ground Face workers and Loaders",
            "OC_OTHER_MAN_TOT" : "B.Opencast workings Others",
            "ABOVE_CLERICAL_MAN_TOT" : "C.Above ground Clerical & Supervisory Staff (excluding the superior supervisory staff.)",
...
//                        console.log(threeElmenentVal)
// MODIFIED THE CONDITION FOR HANDLING THE 0 CONDITION by Uday Shankar Singhon 17th FEB 2014
                        if(twoCElementVal > 0 && threeElmenentVal  > 0){
                            var errorFor = formFullLabelArr[twoCElementId];
