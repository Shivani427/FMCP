...
$(document).ready(function(){
	...
	$('.cmnt-save').on('click',function(){
		...
		if(viewUserType == 'authuser'){
			var dataPost = {reason:reason, submit:'save_comment', mine_code:mineCode, return_date:returnDate, return_type:returnType, mms_user_id:mmsUserId, returnId:returnId, section_id:sectionId, mineral:mineral, sub_min:sub_min};
		} else {
			var part_no = $('#part_no').val();
