		...
		$.each(tableArr.input, function(index, value){
			...
			$.each(this, function(index, value){
				...
				tableContainer += 	(this.name == null) ? '<span class="serial_no">'+rowsC+'</span>' : 
									(inputType == 'textarea') ? '<div><textarea name="' + inputName + '" id="'+inputId+'" value="'+inputValue+'" class=>"form-control form-control-sm input-field '+inputClass+'" '+inputTitle+'></div>' :
									...
									'<div><input name="' + inputName + '" type="'+inputType+'" id="'+inputId+'" value="'+inputValue+'" class="form-control form-control-sm input-field '+inputClass+'" '+inputMaxLenVal+' '+inputMax+' '+inputMin+' '+inputTitle+'></div>';
				tableContainer += '<div class="err_cv"></div>'+inputAutocomplete;


				mainRowContainer += (this.name == null) ? '<span class="serial_no">'+rowsC+'</span>' : 
									(inputType == 'textarea') ? '<div><textarea name="' + inputName + '" id="'+inputId+'" class="form-control form-control-sm input-field '+inputClass+'"></div>' :
									...
									'<div><input name="' + inputName + '" type="'+inputType+'" id="'+inputId+'" class="form-control form-control-sm input-field '+inputClass+'" '+inputMaxLenVal+' '+inputMax+' '+inputMin+'></div>';
...
function addMoreRow(){
	...
	rowContainer = rowContainer.replace(/class\=\'remove_btn\'\>(.*?)\</g, 'class\=\"remove_btn\"\>\<button type\=\"button\" class\=\"btn btn\-sm btn\-danger remove\_btn\_btn\" onclick\=\"remRow\(\'row_container\-'+incRow+'\'\)\"\><i class\=\"fa fa\-times\"\>\<\/\i\>\<\/button\>\<');
	rowContainer += "</tr>";
