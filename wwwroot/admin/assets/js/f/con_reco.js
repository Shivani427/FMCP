...
$(document).ready(function(){
	...
	$('#frmConReco').on('change', '.metal-value-txtbox', function(){
		var grade_value = $(this).val();
		var elId = $(this).attr('id');
		var elIdArr = elId.split('_');
		var elIdRw = elIdArr[3];
	...
	$('#frmConReco').on('click', '#btn-add-1', function(){
		...
		rowCon += "</td>";
		rowCon += "<td>";
		rowCon += "<div><input type='text' name='open_ore_grade_rowcc' id='open_ore_grade_rowcc' class='form-control open_ore_grade grade-txtbox cvOn cvNum cvReq cvMaxLen' maxLength='5'></div><div class='err_cv'></div>";
		rowCon += "</td>";
	...
	$('#frmConReco').on('click', '#btn-add-2', function(){
		...
		rowCon += "</td>";
		rowCon += "<td>";
		rowCon += "<div><input type='text' name='rec_ore_grade_rowcc' id='rec_ore_grade_rowcc' class='form-control rec_ore_grade grade-txtbox cvOn cvNum cvReq cvMaxLen' maxLength='5'></div><div class='err_cv'></div>";
		rowCon += "</td>";
		rowCon += "<td><i class='fa fa-times btn-rem'></i></td>";
		rowCon += "</tr>";
		rowCon = rowCon.replace(/rowcc/g,rowC);
	...
	$('#frmConReco').on('click', '#btn-add-3', function(){
		...
		rowCon += "</td>";
		rowCon += "<td>";
		rowCon += "<div><input type='number' name='treat_ore_grade_rowcc' id='treat_ore_grade_rowcc' class='form-control treat_ore_grade grade-txtbox cvOn cvNum cvReq cvMaxLen' maxLength='5'></div><div class='err_cv'></div>";
		rowCon += "</td>";
		rowCon += "<td><i class='fa fa-times btn-rem'></i></td>";
		rowCon += "</tr>";
		rowCon = rowCon.replace(/rowcc/g,rowC);
	...
	$('#frmConReco').on('click', '#btn-add-4', function(){
		...
		rowConOne += "</td>";
		rowConOne += "<td>";
		rowConOne += "<div><input type='text' name='con_obt_quantity_rowcc' id='con_obt_quantity_rowcc' class='form-control con_obt_quantity quantity-txtbox cvOn cvNum cvReq cvMaxLen' maxLength='16'></div><div class='err_cv'></div>";
		rowConOne += "</td>";
		rowConOne += "</tr>";
		...
		var rowConTwo = "<tr>";
		rowConTwo += "<td>";
		rowConTwo += "<div><input type='text' name='con_obt_grade_rowcc' id='con_obt_grade_rowcc' class='form-control con-obt-grade grade-txtbox cvOn cvReq cvMaxLen' maxLength='5'></div><div class='err_cv'></div>";
		rowConTwo += "</td>";
		rowConTwo += "</tr>";
		...
		var rowConThree = "<tr>";
		rowConThree += "<td>";
		rowConThree += "<div><input type='text' name='con_obt_metal_value_rowcc' id='con_obt_metal_value_rowcc' class='form-control metal-value-txtbox cvOn cvReq cvMaxLen' maxLength='16'></div><div class='err_cv'></div>";
		rowConThree += "</td>";
	...
	$('#frmConReco').on('click', '#btn-add-5', function(){
		...
		rowCon += "</td>";
		rowCon += "<td>";
		rowCon += "<div><input type='number' name='tail_ore_grade_rowcc' id='tail_ore_grade_rowcc' class='form-control tail_ore_grade grade-txtbox cvOn cvNum cvReq cvMaxLen' maxLength='5'></div><div class='err_cv'></div>";
		rowCon += "</td>";
		rowCon += "<td><i class='fa fa-times btn-rem'></i></td>";
		rowCon += "</tr>";
		rowCon = rowCon.replace(/rowcc/g,rowC);
	...
	$('#frmConReco').on('click', '#btn-add-6', function(){
		...
		rowConOne += "</td>";
		rowConOne += "<td>";
		rowConOne += "<div><input type='text' name='close_con_quantity_rowcc' id='close_con_quantity_rowcc' class='form-control close_con_quantity quantity-txtbox cvOn cvNum cvReq cvMaxLen' maxLength='16'></div><div class='err_cv'></div>";
		rowConOne += "</td>";
		rowConOne += "</tr>";
		rowConOne = rowConOne.replace(/rowcc/g,rowC);
		...
		var rowConTwo = "<tr>";
		rowConTwo += "<td>";
		rowConTwo += "<div><input type='text' name='close_con_grade_rowcc' id='close_con_grade_rowcc' class='form-control close-con-grade grade-txtbox cvOn cvNum cvReq cvMaxLen' maxLength='16'></div><div class='err_cv'></div>";
		rowConTwo += "</td>";
