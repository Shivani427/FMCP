...
function mReservTot(mRes) {
    ...
    for(var i=1; i <= 3; i++) {
        ...
        mReserv += (rs != '') ? parseInt(rs) : 0;
    }
    
    $('#mReserv'+mRes+'Tot').text(mReserv);
...
function rResourceTot(rRes) {
    ...
    for(var i=4; i <= 10; i++) {
        ...
        rResource += (rs != '') ? parseInt(rs) : 0;
    }
    
    $('#rResource'+rRes+'Tot').text(rResource);
...
function resResourceTot(res) {
    ...
    $('#'+res+'Tot').text(parseInt(mRes) + parseInt(rRes));
