    ...
    $('#frmActivityDetails').on('submit', function(){
        ...
        for(var i=1; i<=minCnt; i++){
            ...
            for(var n=1; n<=grdcnt; n++){
                ...
                if(secNo == 3){
                    var comboQnt = (parseFloat(opnQnt) + parseFloat(supQnt) + parseFloat(impQnt)) - (parseFloat(consQnt) + parseFloat(buyerQnt));
                } else {
                    var comboQnt = (parseFloat(opnQnt) + parseFloat(supQnt) + parseFloat(impQnt)) - parseFloat(buyerQnt);
                }
