...
$(document).ready(function(){
	...
	$('#frmActivityDetails').on('change', '#trad_ac_tbl .mineral',function(){
		...
		if(mineral != ''){
            ...
            if(mineral != 'NIL'){
                ...
                $('#buyer_regNo_1_1_1').val('0').attr('readonly','readonly');
	...
	$('#frmActivityDetails').on('click', '#trad_ac_tbl .supplier_add_more',function(){
		...
		rowCon += '<div><input type="text" name="reg_no_rowcc_sbcc" id="reg_no_rowcc_sbcc" class="form-control form-control-sm text-fields supplier_registration supplier_reg_noClass_rowcc ui-autocomplete-input cvOn cvReq"></div>';
		...
		rowCon += '<div class="err_cv"></div>';
		rowCon += "</td>";
		rowCon += "<td class='v_a_base'><i class='fa fa-times btn-rem btn_rem_supplier'></i></td>";
		rowCon += "</tr>";
	...
	$('#frmActivityDetails').on('click', '#trad_ac_tbl .import_add_more',function(){
		...
		var rowCon = "<tr>";
		rowCon += "<td class='v_a_base'>";
		rowCon += '<div><input type="text" name="import_country_rowcc_sbcc" id="import_country_rowcc_sbcc" class="form-control form-control-sm text-fields import_country import_countryClass_rowcc ui-autocomplete-input cvOn cvAlphaNum cvNotReq" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true"></div>';
		...
		rowCon += "</td>";
		rowCon += "<td class='v_a_base'><i class='fa fa-times btn-rem btn_rem_import'></i></td>";
		rowCon += "</tr>";
		rowCon = rowCon.replace(/rowcc/g,msId);
		rowCon = rowCon.replace(/sbcc/g,rowC);
	...
	$('#frmActivityDetails').on('click', '#trad_ac_tbl .add_more_buyer_btn',function(){
		...
		var rowCon = "<tr>";
		rowCon += "<td class='v_a_base'>";
		rowCon += '<div><input type="text" name="buyer_regNo_rowcc_sbcc" id="buyer_regNo_rowcc_sbcc" class="form-control form-control-sm text-fields buyer_registration buyer_regNoClass_rowcc ui-autocomplete-input cvOn cvReq" autocomplete="off" role="textbox" aria-autocomplete="list" aria-haspopup="true"></div>';
		rowCon += '<div class="err_cv"></div>';
		rowCon += '<div class="sugg-box autocomp"></div>';
		rowCon += "</td>";
		rowCon += "<td class='v_a_base'>";
		...
		rowCon += '<div class="err_cv"></div>';
		rowCon += "</td>";
		rowCon += "<td class='v_a_base'><i class='fa fa-times btn-rem btn_rem_buyer'></i></td>";
		rowCon += "</tr>";
		rowCon = rowCon.replace(/rowcc/g,msId);
		rowCon = rowCon.replace(/sbcc/g,rowC);
	...
	$(document).on('click','#frmActivityDetails #trad_ac_tbl .trad_ac_buyer_tbl .btn_rem_buyer',function(){
		...
		$(this).closest('tr').remove();
		tradAcRqvRw('#'+tId, '.buyer_registration', 'buyer_regNo_'+mId, '.buyer_quantity', 'buyer_quantity_'+mId, '.buyer_value', 'buyer_value_'+mId);
		tradAcDelRwSyn('#'+tId);
		tradAcCounts();
