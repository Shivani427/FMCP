...
$(document).ready(function(){
    ...
    $('.company').on('click', function () {
        ...
        var validateName = $('#validateNamemsg').val();

           // $('#validateNamemsg').val();
        alert(validateName);
        var validateAddress = $('#validateAddress1msg').val();
        
        //let companyvalidation=[];
        //companyvalidation[0] = validateNamemsg;
        //companyvalidation[1] = validateAddress1msg;
...
function showAlrt(msg){
	...
	remAlrt();
	var alrtCon = '<div class="toast alrt-danger" role="alert" aria-live="assertive" aria-atomic="true" data-delay="50000">';
